    ...
    <div class="container">
        <div class="row align-items-center">
                    ...
                    <div class="mega-category-menu">
                        ...
                        <?php
                            $headerCategories = \App\Models\Category::where('parent_id', null)
                                ...
                                ->get();
                        ?>
                        <?php if($headerCategories->count() > 0): ?>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <!-- Start Nav Social -->
                <?php if(setting('site_facebook') || setting('site_twitter') || setting('site_instagram') || setting('site_youtube')): ?>
...
<?php /**PATH D:\projects\ident-admin\resources\views/clients/partials/header.blade.php ENDPATH**/ ?>