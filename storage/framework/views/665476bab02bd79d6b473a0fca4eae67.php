                    ...
                    <div class="product-info">
                        ...
                        <p class="category"><i class="lni lni-tag"></i>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->category): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->category->parent): ?>
                        ...
                        <p class="info-text"><?php echo $product->description ? : 'Описание товара скоро появится.'; ?></p>
...
<?php echo $__env->make('clients.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/clients/shop/product-details.blade.php ENDPATH**/ ?>