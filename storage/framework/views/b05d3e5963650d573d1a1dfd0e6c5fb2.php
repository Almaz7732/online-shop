        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="/admin" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('build/images/site-logo-remove-bg.png')); ?>" alt="" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/site-logo-remove-bg.png')); ?>" alt="" height="50">
                    </span>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('build/images/users/user-dummy-img.jpg')); ?>"
                    alt="Header Avatar">
...
<?php /**PATH D:\projects\ident-admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>