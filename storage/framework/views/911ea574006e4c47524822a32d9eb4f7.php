                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p class="card-title-desc">Manage About Us page content and settings</p>
                        </div>
                        <div class="col-md-6 text-end">
                            <a href="<?php echo e(route('admin.about-us.create')); ?>" class="btn btn-primary">
                    ...
                    <div class="table-responsive">
                        <table id="about-us-table" class="table table-bordered dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#about-us-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('admin.about-us.index')); ?>",
                columns: [
        ...
        function deleteRecord(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(url("admin/about-us")); ?>/' + id,
                        type: 'DELETE',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            $('#about-us-table').DataTable().ajax.reload();
                        },
                        error: function(xhr) {
                            Swal.fire(
                                'Error!',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\ident-admin\resources\views/admin/about-us/index.blade.php ENDPATH**/ ?>