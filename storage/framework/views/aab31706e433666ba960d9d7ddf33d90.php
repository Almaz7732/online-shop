...
<?php $__env->slot('li_1'); ?> Управление <?php $__env->endSlot(); ?>
...
$(document).ready(function() {
    ...
    const table = $('#orders-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route("admin.orders.data")); ?>',
            type: 'GET'
        },
        columns: [
            { data: 'id', name: 'id' },
    ...
    $('#save-status').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(url("admin/orders")); ?>/' + currentOrderId,
            method: 'PUT',
            data: {
                status: newStatus,
    ...
    $(document).on('click', '.delete-order', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo e(url("admin/orders")); ?>/' + orderId,
                    method: 'DELETE',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>'
                    },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\ident-admin\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>