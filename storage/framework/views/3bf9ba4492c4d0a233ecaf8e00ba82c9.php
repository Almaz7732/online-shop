        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('site-settings.carousel.store')); ?>" method="POST" enctype="multipart/form-data" id="carousel-form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                   id="subtitle" name="subtitle" value="<?php echo e(old('subtitle')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                      ...
                                                      placeholder="Enter slide description"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                                       id="text_color" name="text_color" value="<?php echo e(old('text_color')); ?>"
                                                       placeholder="#ffffff">
...
unset($__errorArgs, $__bag); ?>"
                                                   id="background_overlay" name="background_overlay" value="<?php echo e(old('background_overlay', 'rgba(0,0,0,0.3)')); ?>"
                                                   placeholder="rgba(0,0,0,0.3)">
                                            <div class="form-text">CSS background value for text overlay</div>
                                            <?php $__errorArgs = ['background_overlay'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\ident-admin\resources\views/admin/site-settings/carousel/create.blade.php ENDPATH**/ ?>