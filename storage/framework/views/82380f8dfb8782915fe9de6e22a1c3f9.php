        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <h4 class="card-title">Create New About Content</h4>
                    ...
                    <form action="<?php echo e(route('admin.about.store')); ?>" method="POST" id="about-form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                      id="content" name="content" rows="15"><?php echo e(old('content')); ?></textarea>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       id="is_active" name="is_active" <?php echo e(old('is_active') ? 'checked' : 'checked'); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\ident-admin\resources\views/admin/about/create.blade.php ENDPATH**/ ?>