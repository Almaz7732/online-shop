...
<head>
    ...
    <?php else: ?>
        <title><?php echo $__env->yieldContent('title',  config('app.name', 'Example') . ' - Магазин техники и гаджетов'); ?></title>
        <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Поставка техники и гаджетов в Кыргызстан'); ?>" />
...
<?php /**PATH /var/www/html/resources/views/clients/layouts/app.blade.php ENDPATH**/ ?>