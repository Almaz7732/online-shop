            ...
            <div class="col-12">
                ...
                <div class="map-tabs mb-3">
                    <ul class="nav nav-tabs d-flex justify-content-center" id="mapTabs" role="tablist">
                        ...
                        <?php if($mapSettings && $mapSettings->is_active && $mapSettings->google_maps_api_key): ?>
                        <li class="nav-item" role="presentation">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-info">
                    ...
                    <div class="content">
                        <h4>Address</h4>
                        <p>
                            <?php if($mapSettings && $mapSettings->company_address): ?>
...
<?php echo $__env->make('clients.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\ident-admin\resources\views/clients/shop/about.blade.php ENDPATH**/ ?>