                ...
                <div class="row">
                    <div class="col-7">
                        <div class="text-primary p-3">
                            ...
                            <p>{{ config('app.name', 'Example') }} Dashboard</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            <img src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('build/images/users/user-dummy-img.jpg') }}" alt="" class="img-thumbnail rounded-circle">
                        </div>
...
function loadStatistics() {
    ...
    // Make AJAX request
    fetch(`{{ route('admin.statistics') }}?start_date=${startDate}&end_date=${endDate}`)
