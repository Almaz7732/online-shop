...
@section('title', $about->title . ' - Ident')
            ...
            <div class="col-12">
                ...
                <div class="map-tabs mb-3">
                    <ul class="nav nav-tabs d-flex justify-content-center" id="mapTabs" role="tablist">
                        ...
                        @if($mapSettings && $mapSettings->is_active && $mapSettings->google_maps_api_key)
                        <li class="nav-item" role="presentation">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-info">
                    ...
                    <div class="content">
                        <h4>Address</h4>
                        <p>
                            @if($mapSettings && $mapSettings->company_address)
                                {{ $mapSettings->company_address }}
                            @elseif(setting('site_address'))
...
<script src="{{ URL::asset('build/libs/bootstrap/js/bootstrap5-1-3.bundle.min.js')}}"></script>
...
<script>
    ...
    const mapConfig = {
        ...
        lat: {{ $mapSettings->latitude ?? 55.7558 }},
        lng: {{ $mapSettings->longitude ?? 37.6176 }},
        zoom: {{ $mapSettings->zoom_level ?? 15 }},
        mapType: '{{ $mapSettings->map_style ?? "roadmap" }}',
        address: '{{ addslashes($mapSettings->company_address ?? "Our Office") }}'
    };
        ...
        const infoWindow = new google.maps.InfoWindow({
            content: `
                <div style="padding: 10px; max-width: 300px;">
                    <h5 style="margin: 0 0 10px 0; color: #333;">{{ setting('site_name') ?? 'Our Company' }}</h5>
