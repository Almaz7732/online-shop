...
@push('styles')
    <link href="{{ URL::asset('build/libs/intl-tel-input/build/css/intlTelInput.min.css') }}" rel="stylesheet">
@endpush

@section('title', 'Корзина - ' . config('app.name', 'Example'))
...
@section('scripts')
    <script src="{{ URL::asset('build/libs/intl-tel-input/build/js/intlTelInputWithUtils.min.js') }}"></script>
    ...
    function initializePhoneInput() {
        ...
        if (phoneInput && window.intlTelInput) {
            ...
            phoneInput.iti = window.intlTelInput(phoneInput, {
                ...
                utilsScript: '{{ asset("build/libs/intl-tel-input/build/js/intlTelInputWithUtils.min.js") }}'
            });
        }
    }
