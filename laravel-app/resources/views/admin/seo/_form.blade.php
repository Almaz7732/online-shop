        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="page_type" name="page_type" required>
                ...
                @foreach($pageTypes as $key => $value)
                    <option value="{{ $key }}" {{ old('page_type', isset($seoSetting) ? $seoSetting->page_type : '') == $key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="page_identifier" name="page_identifier"
                   value="{{ old('page_identifier', isset($seoSetting) ? $seoSetting->page_identifier : '') }}"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="meta_title" name="meta_title" maxlength="70"
                   value="{{ old('meta_title', isset($seoSetting) ? $seoSetting->meta_title : '') }}"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                   value="{{ old('meta_keywords', isset($seoSetting) ? $seoSetting->meta_keywords : '') }}"
    ...
    <div class="col-12">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="meta_description" name="meta_description" rows="3" maxlength="160"
                      placeholder="SEO описание (до 160 символов)">{{ old('meta_description', isset($seoSetting) ? $seoSetting->meta_description : '') }}</textarea>
            <div class="form-text">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="og_title" name="og_title" maxlength="70"
                   value="{{ old('og_title', isset($seoSetting) ? $seoSetting->og_title : '') }}"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="og_image" name="og_image"
                   value="{{ old('og_image', isset($seoSetting) ? $seoSetting->og_image : '') }}"
    ...
    <div class="col-12">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="og_description" name="og_description" rows="3" maxlength="160"
                      placeholder="Описание для соцсетей">{{ old('og_description', isset($seoSetting) ? $seoSetting->og_description : '') }}</textarea>
            <div class="form-text">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="canonical_url" name="canonical_url"
                   value="{{ old('canonical_url', isset($seoSetting) ? $seoSetting->canonical_url : '') }}"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select class="form-select" id="robots_meta" name="robots_meta">
                <option value="index,follow" {{ old('robots_meta', isset($seoSetting) ? $seoSetting->robots_meta : 'index,follow') == 'index,follow' ? 'selected' : '' }}>
                    index,follow (по умолчанию)
                </option>
                <option value="noindex,follow" {{ old('robots_meta', isset($seoSetting) ? $seoSetting->robots_meta : '') == 'noindex,follow' ? 'selected' : '' }}>
                    noindex,follow
                </option>
                <option value="index,nofollow" {{ old('robots_meta', isset($seoSetting) ? $seoSetting->robots_meta : '') == 'index,nofollow' ? 'selected' : '' }}>
                    index,nofollow
                </option>
                <option value="noindex,nofollow" {{ old('robots_meta', isset($seoSetting) ? $seoSetting->robots_meta : '') == 'noindex,nofollow' ? 'selected' : '' }}>
                    noindex,nofollow
                </option>
            </select>
        </div>
    ...
    <div class="col-12">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                   {{ old('is_active', isset($seoSetting) ? $seoSetting->is_active : true) ? 'checked' : '' }}>
