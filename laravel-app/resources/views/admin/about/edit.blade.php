        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.about.update', $about->id) }}" method="POST" id="about-form">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('content') is-invalid @enderror"
                                                      id="content" name="content" rows="15">{{ old('content', $about->content) }}</textarea>
                                            @error('content')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       id="is_active" name="is_active" {{ old('is_active', $about->is_active) ? 'checked' : '' }}>
                                        ...
                                        <div class="border-top pt-3">
                                            ...
                                            <small class="text-muted d-block">Created: {{ $about->created_at->format('M d, Y H:i') }}</small>
                                            <small class="text-muted d-block">Updated: {{ $about->updated_at->format('M d, Y H:i') }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
