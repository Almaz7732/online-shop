...
{{--                                @endif--}}
                                ...
                                <div class="button">
                                    <a href="javascript:void(0)" class="btn" data-product-id="{{ $product->id }}" title="Добавить в корзину"><i class="lni lni-cart"></i> В корзину</a>
                                    <a href="{{ route('shop.product-details', $product->slug) }}" class="btn mt-2" title="Показать">Показать</a>
                                </div>
                                <div class="wishlist-btn">
                                    <a href="javascript:void(0)" class="wishlist-toggle active" data-wishlist-id="{{ $product->id }}" title="Удалить из избранного">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadWishlistProducts() {
        ...
        if ({{ $wishlistProducts->count() }} === 0 && wishlist.length > 0) {
