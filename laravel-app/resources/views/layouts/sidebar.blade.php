...
{{--                    <a href="javascript: void(0);" class="has-arrow waves-effect">--}}
{{--                        <i class="bx bx-home-circle"></i>--}}
{{--                        <span key="t-templates">@lang('translation.Templates')</span>--}}
{{--                    </a>--}}
{{--                    <ul class="sub-menu" aria-expanded="false">--}}
{{--                        <li>--}}
...
{{--                </li>--}}
                ...
                <li>
                    <a href="{{ route('admin.map-settings.index') }}" class="waves-effect">
                        <i class="bx bx-map"></i>
                ...
                <li>
                    <a href="{{ route('site-settings.index') }}" class="waves-effect">
                        <i class="bx bx-cog"></i>
